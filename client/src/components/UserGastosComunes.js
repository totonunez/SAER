    ...
    render() {
        ...
        <div id="User_Gastos_comunes">
          ...
          <svg className="Rectngulo_13">
            <rect id="Rectngulo_13" rx={0} ry={0} x={0} y={0} width={105} height={21}>
            </rect>
          </svg>
          ...
          <svg className="Rectngulo_16">
            <rect id="Rectngulo_16" rx={0} ry={0} x={0} y={0} width={75} height={15}>
            </rect>
          </svg>
          <div id="_234802_w">
            <span>$ 234.802</span>
          ...
          <svg className="Rectngulo_17">
            <rect id="Rectngulo_17" rx={0} ry={0} x={0} y={0} width={105} height={21}>
            </rect>
          </svg>
          ...
          <svg className="Rectngulo_19">
            <rect id="Rectngulo_19" rx={0} ry={0} x={0} y={0} width={105} height={21}>
            </rect>
          </svg>
          ...
          <svg className="Rectngulo_21">
            <rect id="Rectngulo_21" rx={0} ry={0} x={0} y={0} width={104} height={21}>
            </rect>
          </svg>
          ...
          <svg className="Rectngulo_23">
            <rect id="Rectngulo_23" rx={0} ry={0} x={0} y={0} width={106} height={21}>
            </rect>
          </svg>
          <svg className="Rectngulo_24">
            <rect id="Rectngulo_24" rx={0} ry={0} x={0} y={0} width={106} height={15}>
            </rect>
          </svg>
          <div id="_234802_bj">
            <span>$ 234.802</span>
          ...
          <svg className="Rectngulo_27">
            <rect id="Rectngulo_27" rx={16} ry={16} x={0} y={0} width={201} height={75}>
            </rect>
          </svg>
          <svg className="Rectngulo_28">
            <rect id="Rectngulo_28" rx={19} ry={19} x={0} y={0} width={194} height={75}>
            </rect>
          </svg>
          ...
          <img id="Imagen_2_bv" src="Imagen_2_bv.png" srcSet="Imagen_2_bv.png 1x, Imagen_2_bv@2x.png 2x" />
          <svg className="Lnea_21" viewBox="0 0 1 752">
            <path id="Lnea_21" d="M 0 0 L 0 752">
            </path>
          </svg>
          <svg className="Trazado_2" viewBox="0 0 121.311 23">
            <path id="Trazado_2" d="M 0 0 L 37.13742065429688 0 L 121.3109130859375 0 L 121.3109130859375 23 L 0 23 L 0 0 Z">
            </path>
          </svg>
          <svg className="Rectngulo_37">
            <rect id="Rectngulo_37" rx={0} ry={0} x={0} y={0} width={122} height={32}>
            </rect>
          </svg>
